        ...
        <div class="col-xs-12">
            <div class="box">
                {{-- <div class="box-header">
                    <a href="{{ route('info.edit') }}" class="btn btn-primary">
                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach ($listProduct as $info)
                            <tr>
                                <td>{{$info->name}}</td>
                                <td>
                                    <div>
                                        <a class="btn btn-app btn-primary"
                                            href="{{route("info.edit", ['id' => $info->id])}}"><i
